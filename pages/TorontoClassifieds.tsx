    ...
    <div className="overflow-x-hidden">
      ...
      <section className="bg-gradient-to-br from-slate-900 via-primary to-primary-light text-white py-20 md:py-28 relative overflow-hidden">
        ...
        <div className="w-full px-4 sm:px-6 lg:px-10 relative z-10 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/search" className="bg-white text-primary font-black px-10 py-5 rounded-2xl hover:bg-slate-50 transition-all shadow-xl text-sm uppercase tracking-widest">
              Browse All Listings
            </Link>
            <Link to="/post-ad" className="bg-secondary hover:bg-secondary-hover text-white font-black px-10 py-5 rounded-2xl transition-all shadow-xl text-sm uppercase tracking-widest">
              Post Free Ad
            </Link>
          </div>
        </div>
      ...
      <main className="w-full px-4 sm:px-6 lg:px-10 py-16 md:py-24">
        ...
        <section className="mb-20">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4">
            {[
              ...
              <Link key={cat.name} to={`/search?cat=${encodeURIComponent(cat.name)}`} className="bg-white p-6 rounded-2xl border border-slate-100 text-center hover:border-primary hover:shadow-lg transition-all group">
        ...
        <section className="bg-primary/5 rounded-3xl p-10 md:p-16 max-w-4xl mx-auto">
          ...
          <div className="mt-8">
            <Link to="/safety-tips" className="text-xs font-black text-primary uppercase tracking-widest hover:underline">Read Full Safety Guide →</Link>
          </div>
        </section>
      </main>
    </div>
