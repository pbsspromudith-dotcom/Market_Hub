    ...
    <div className="overflow-x-hidden">
      <section className="bg-gradient-to-br from-amber-800 via-amber-600 to-orange-500 text-white py-20 md:py-28 relative overflow-hidden">
        ...
        <div className="w-full px-4 sm:px-6 lg:px-10 relative z-10 text-center">
          ...
          <Link to="/search?cat=Local%20Services" className="bg-white text-amber-700 font-black px-10 py-5 rounded-2xl hover:bg-slate-50 transition-all shadow-xl text-sm uppercase tracking-widest inline-block">
            Find Services
          </Link>
        </div>
      </section>
        ...
        <section className="mb-20">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <Link key={svc.name} to={`/search?cat=Local%20Services&sub=${encodeURIComponent(svc.name)}`} className="bg-white p-6 rounded-2xl border border-slate-100 text-center hover:border-amber-500 hover:shadow-lg transition-all group">
