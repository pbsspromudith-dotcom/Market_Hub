  ...
  const sections = [
    {
      ...
      description:
        "Always use caution when communicating and meeting with other users.",
      icon: "shield",
    ...
    },
    {
      ...
      description:
        "Meeting safely is one of the most important parts of marketplace transactions.",
      icon: "groups",
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              <div className="p-6 bg-slate-900 text-white rounded-3xl relative overflow-hidden">
                <span className="material-icons absolute -right-4 -top-4 text-white/10 text-8xl">
                  place
                </span>
              ...
              <div className="p-6 bg-primary/5 rounded-3xl border border-primary/10">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Consider meeting at a mechanic shop, near Service Ontario
                  locations, or at police-designated safe exchange areas.
                </p>
              </div>
            </div>
          </div>
    ...
    },
    {
      ...
      description:
        "Online payment scams are common. Never release items until payment is confirmed.",
      icon: "payments",
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              {[
                ...
                <div
                  key={p}
                  className="p-3 bg-white border border-slate-100 rounded-xl text-sm text-slate-600 flex items-center gap-3"
                >
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 gap-2">
              {[
                ...
                <div
                  key={risk}
                  className="p-3 bg-red-50 text-red-700 rounded-xl text-xs font-bold flex items-center gap-2 border border-red-100"
                >
        ...
        <div className="space-y-6">
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              <div
                key={scam.t}
                className="p-6 bg-white border border-slate-100 rounded-3xl hover:shadow-xl transition-all group"
              >
                <h5 className="font-bold text-slate-900 mb-2 group-hover:text-primary transition-colors">
                  {scam.t}
                </h5>
    ...
    },
    {
      ...
      description:
        "Vehicle and rental transactions require additional precautions.",
      icon: "category",
        ...
        <div className="space-y-8">
          ...
          <div className="p-6 bg-cyan-900 text-white rounded-3xl">
            ...
            <p className="text-xs text-cyan-100 leading-relaxed mb-4">
              Be cautious if employers request upfront payment, promise
              unrealistic income, or ask for banking info immediately. Research
              employers thoroughly.
            </p>
          </div>
        </div>
      ),
    },
    {
      ...
      description:
        "Online safety also includes protecting your personal information.",
      icon: "fingerprint",
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              >
                <span className="material-icons text-secondary mb-2">
                  block
                </span>
      ...
      <div className="bg-gradient-to-br from-secondary to-secondary-hover text-white py-24 px-4 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-6 relative z-10">
          ...
          <p className="text-lg md:text-xl text-white/80 font-medium max-w-2xl mx-auto">
            Your safety is our priority. Learn how to stay protected while
            buying, selling, and advertising online.
          </p>
          ...
          <aside className="lg:w-80 shrink-0">
            <div className="sticky top-32 space-y-8">
              <div className="bg-white rounded-[2rem] p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100">
                ...
                <nav className="space-y-1">
                  {sections.map((section) => (
                    ...
                    >
                      <div
                        className={`w-10 h-10 rounded-xl flex items-center justify-center transition-all duration-300 ${activeSection === section.id ? "bg-secondary text-white shadow-lg shadow-secondary/20" : "bg-slate-100 text-slate-400 group-hover:bg-white group-hover:text-secondary group-hover:shadow-md"}`}
                      >
                      ...
                      <span
                        className={`text-[13px] font-bold leading-tight transition-colors ${activeSection === section.id ? "text-secondary" : "text-slate-600 group-hover:text-secondary"}`}
                      >
                        {section.shortTitle}
                      </span>
                    </button>
              ...
              <div className="p-8 bg-slate-900 text-white rounded-[2rem] shadow-2xl relative overflow-hidden group">
                ...
                <h4 className="text-xs font-black uppercase tracking-widest mb-2 opacity-60">
                  Need Assistance?
                </h4>
                ...
                <a
                  ...
                  className="inline-flex items-center gap-3 px-6 py-3 bg-white text-slate-900 rounded-xl font-bold text-xs hover:bg-secondary hover:text-white transition-all shadow-lg"
                >
            ...
            {sections.map((section) => (
              ...
              >
                <div className="flex items-center gap-6 mb-10">
                  <div
                    className={`w-20 h-20 rounded-[2rem] ${section.color} flex items-center justify-center shadow-2xl shadow-black/5 relative`}
                  >
                ...
                <div
                  className={`bg-white rounded-[3rem] p-8 md:p-12 transition-all duration-700 border ${activeSection === section.id ? "shadow-[0_40px_80px_-15px_rgba(0,0,0,0.1)] border-secondary/20 ring-8 ring-secondary/5" : "shadow-[0_8px_30px_rgba(0,0,0,0.02)] border-slate-100"}`}
                >
                  {section.content}
                </div>
              </section>
              ...
              <div className="grid md:grid-cols-2 gap-12">
                <div className="space-y-6">
                  ...
                  <p className="text-slate-500 text-sm leading-relaxed">
                    Report suspicious listings, fraud attempts, or unsafe
                    behavior. Your reports help improve marketplace safety for
                    everyone.
                  </p>
                  <div className="flex flex-wrap gap-2">
                    {["Fraud", "Fake Ads", "Harassment", "Illegal items"].map(
                      (t) => (
                        <span
                          key={t}
                          className="px-3 py-1 bg-slate-100 text-slate-600 rounded-lg text-[10px] font-bold uppercase tracking-wider"
                        >
                          {t}
                        </span>
                      ),
                ...
                <div className="space-y-6">
                  ...
                  <p className="text-slate-500 text-sm leading-relaxed">
                    Always supervise transactions involving minors. Keep family
                    members informed about meetings and use public locations.
                  </p>
                </div>
              </div>
