      ...
      <section className="bg-white border-b border-slate-200 pt-24 pb-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-slate-500 text-lg md:text-xl font-medium max-w-2xl mx-auto leading-relaxed">
            Whether you're a buyer, seller, or developer, we're here to ensure
            your HitAds experience is exceptional.
          </p>
        </div>
      </section>
          ...
          <div className="lg:col-span-5 space-y-12">
            ...
            <div className="bg-slate-900 rounded-[3rem] p-10 text-white relative overflow-hidden">
              ...
              <h3 className="text-xl font-black mb-8 relative z-10">
                Sample Department Directory
              </h3>
              <div className="space-y-8 relative z-10">
                {departments.map((dept, i) => (
                  <div key={i} className="group cursor-pointer">
                    <div className="flex justify-between items-center mb-1">
                      <h4 className="text-xs font-black uppercase tracking-widest text-slate-400 group-hover:text-primary transition-colors">
                        {dept.name}
                      </h4>
          ...
          <div className="flex gap-4">
            {[
              ...
              <a
                key={s}
                href="#"
                className="w-12 h-12 rounded-2xl bg-slate-50 flex items-center justify-center text-slate-400 hover:bg-primary hover:text-white transition-all shadow-sm hover:shadow-primary/20 hover:-translate-y-1"
              >
