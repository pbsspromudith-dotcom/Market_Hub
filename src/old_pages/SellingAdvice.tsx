  ...
  const sections = [
    {
      ...
      description:
        "A well-written listing improves visibility and increases serious inquiries.",
      icon: "edit_note",
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="space-y-4">
            ...
            <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100 italic text-sm text-slate-600">
              ...
              "Laptop for Sale"
              <span className="text-[10px] font-black uppercase text-primary block mt-3 mb-1">
                Good Example
              </span>
              "Dell XPS 13 – 16GB RAM – Excellent Condition – Toronto"
            </div>
            <p className="text-xs text-slate-500">
              Include: Product name, Brand, Specs, Condition, and Location.
            </p>
          </div>
          <div className="space-y-4">
            <h4 className="font-bold text-slate-800 flex items-center gap-2">
    ...
    },
    {
      ...
      description:
        "High-quality photos increase trust and improve response rates.",
      icon: "photo_camera",
            ...
            <div className="relative group overflow-hidden rounded-[2rem] shadow-xl">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-purple-900/60 to-transparent flex items-end p-6">
                <p className="text-white text-xs font-bold italic">
                  Listings with multiple clear photos receive more inquiries.
                </p>
              </div>
            </div>
          </div>
    ...
    },
    {
      ...
      description:
        "Correct pricing is one of the most important factors in selling successfully.",
      icon: "sell",
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-2">
              {[
                ...
                <span
                  key={f}
                  className="px-3 py-1 bg-emerald-100 text-emerald-700 rounded-lg text-[11px] font-bold"
                >
                  {f}
                </span>
              ))}
            ...
            <p className="text-xs text-slate-500 leading-relaxed">
              Research similar listings to stay competitive.
            </p>
          </div>
    ...
    },
    {
      ...
      description:
        "Improve your chances of completing a sale with these strategies.",
      icon: "bolt",
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="p-6 bg-white border border-slate-100 rounded-3xl text-center space-y-3 shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="text-[11px] text-slate-500">
              Buyers contact multiple sellers. Quick replies win.
            </p>
          </div>
          <div className="p-6 bg-white border border-slate-100 rounded-3xl text-center space-y-3 shadow-sm hover:shadow-md transition-shadow">
            <span className="material-icons text-orange-500 text-3xl">
            ...
            <p className="text-[11px] text-slate-500">
              Renew listings regularly and update photos/pricing.
            </p>
          </div>
          <div className="p-6 bg-white border border-slate-100 rounded-3xl text-center space-y-3 shadow-sm hover:shadow-md transition-shadow">
            <span className="material-icons text-orange-500 text-3xl">
            ...
            <p className="text-[11px] text-slate-500">
              Offer flexible pickup times or local delivery.
            </p>
          </div>
        </div>
      ),
    },
    {
      ...
      description:
        "Special advice for the most popular categories on HitAds.ca.",
      icon: "category",
        ...
        <div className="space-y-8">
          ...
          <div className="p-6 bg-cyan-900 text-white rounded-3xl">
            ...
            <p className="text-xs text-cyan-100 leading-relaxed">
              Always provide Length, Width, and Height. Be honest about stains,
              wear, and assembly status. Accurate measurements reduce failed
              pickups.
            </p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              {[
                {
                  t: "Fake Payment Confirmation",
                  d: "Funds are never actually received.",
                },
                {
                  t: "Overpayment Scam",
                  d: 'Buyer requests refund for "accidental" overpayment.',
                },
                {
                  t: "Shipping Scam",
                  d: "Requests shipment before payment clears.",
                },
              ].map((scam) => (
                <div
                  key={scam.t}
                  className="p-4 bg-white border border-red-100 rounded-2xl shadow-sm"
                >
          ...
          <div className="bg-red-600 text-white p-6 rounded-[2rem] relative overflow-hidden">
            ...
            <h4 className="font-black text-xs uppercase tracking-widest mb-4 opacity-80">
              Protection Tips
            </h4>
      ...
      content: (
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            <div
              key={season.s}
              className="p-4 bg-white border border-indigo-50 rounded-2xl text-center group hover:bg-indigo-600 transition-all duration-300"
            >
              <span className="material-icons text-indigo-600 mb-2 group-hover:text-white transition-colors">
                {season.i}
              </span>
              <h5 className="font-black text-[10px] uppercase text-indigo-400 group-hover:text-indigo-200 block mb-1">
                {season.s}
              </h5>
              <p className="text-[11px] font-bold text-slate-700 group-hover:text-white">
                {season.t}
              </p>
            </div>
          ))}
      ...
      <div className="bg-gradient-to-br from-primary to-primary-hover text-white py-24 px-4 relative overflow-hidden">
        <div className="max-w-4xl mx-auto text-center space-y-6 relative z-10">
          ...
          <p className="text-lg md:text-xl text-primary-soft font-medium max-w-2xl mx-auto">
            Create better listings, attract more buyers, and sell faster across
            Canada with our expert selling tips.
          </p>
          <div className="pt-4">
            ...
            <div className="sticky top-32 space-y-8">
              <div className="bg-white rounded-[2.5rem] p-6 shadow-[0_10px_40px_rgb(0,0,0,0.03)] border border-slate-100">
                ...
                <nav className="space-y-1">
                  {sections.map((section) => (
                    ...
                    >
                      <div
                        className={`w-10 h-10 rounded-xl flex items-center justify-center transition-all duration-300 ${activeSection === section.id ? "bg-primary text-white shadow-lg shadow-primary/20" : "bg-slate-50 text-slate-400 group-hover:bg-white group-hover:text-primary"}`}
                      >
              ...
              <div className="p-8 bg-primary rounded-[2.5rem] text-white shadow-2xl relative overflow-hidden group">
                ...
                <p className="text-sm font-medium mb-6 leading-relaxed">
                  Check our first-time seller checklist to get started
                  professionally.
                </p>
                <div className="space-y-3">
                  {[
          ...
          <div className="flex-1 space-y-24">
            {sections.map((section) => (
              ...
              >
                ...
                <div
                  className={`bg-white rounded-[3.5rem] p-8 md:p-12 transition-all duration-700 border ${activeSection === section.id ? "shadow-[0_50px_100px_-20px_rgba(0,0,0,0.12)] border-primary/20 ring-12 ring-primary/5 scale-[1.02]" : "shadow-[0_10px_40px_rgba(0,0,0,0.02)] border-slate-100"}`}
                >
                  {section.content}
                </div>
              </section>
              ...
              <div className="relative z-10 max-w-4xl mx-auto space-y-16">
                <div className="text-center space-y-6">
                  <h3 className="text-4xl font-black tracking-tight">
                    Why Sell on HitAds.ca?
                  </h3>
                  <p className="text-slate-400 max-w-2xl mx-auto">
                    Connecting individuals and businesses across Canada with
                    local buyers.
                  </p>
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4 pt-8">
                    {[
                      ...
                      <div
                        key={b}
                        className="p-4 bg-white/5 rounded-2xl border border-white/10 text-xs font-bold uppercase tracking-widest text-primary-soft"
                      >
                        {b}
                      </div>
                    ))}
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                  <div className="space-y-6">
                    ...
                    <p className="text-sm text-slate-400 leading-relaxed">
                      Professional communication increases buyer confidence.
                      Reply politely, answer clearly, and always inform buyers
                      if an item is sold.
                    </p>
                  </div>
                  <div className="p-8 bg-secondary/10 rounded-[2.5rem] border border-secondary/20 space-y-4">
                    ...
                    <p className="text-[11px] text-slate-400 leading-loose uppercase tracking-widest">
                      HitAds.ca does not guarantee buyers, sellers, or
                      transactions. Users are responsible for verifying all
                      information.
                    </p>
                  </div>
                </div>
