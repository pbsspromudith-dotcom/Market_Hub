    ...
    <div className="overflow-x-hidden">
      <section className="bg-gradient-to-br from-rose-900 via-rose-700 to-pink-500 text-white py-20 md:py-28 relative overflow-hidden">
        ...
        <div className="w-full px-4 sm:px-6 lg:px-10 relative z-10 text-center">
          ...
          <Link href="/search" className="bg-white text-rose-700 font-black px-10 py-5 rounded-2xl hover:bg-slate-50 transition-all shadow-xl text-sm uppercase tracking-widest inline-block">
      ...
      <main className="w-full px-4 sm:px-6 lg:px-10 py-16 md:py-24">
        ...
        <section className="mb-20">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <Link key={svc.name} href="/search" className="bg-white p-6 rounded-2xl border border-slate-100 text-center hover:border-rose-500 hover:shadow-lg transition-all group">
        ...
        <section className="max-w-4xl mx-auto mb-20">
          ...
          <div className="mt-8 text-center sm:text-left">
            <Link href="/post-ad" className="bg-rose-600 text-white font-black px-10 py-5 rounded-2xl hover:bg-rose-700 transition-all shadow-xl text-sm uppercase tracking-widest inline-block">
