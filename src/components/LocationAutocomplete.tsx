...
export const LocationAutocomplete: React.FC<LocationAutocompleteProps> = ({
  ...
  const getInputStyles = () => {
    switch (variant) {
      case 'hero':
        return 'w-full pl-14 pr-10 py-5 bg-transparent border-none focus:ring-0 text-sm font-bold text-slate-800 placeholder:text-slate-400 outline-none';
      case 'navbar':
        return 'w-full bg-transparent border-none focus:ring-0 text-sm font-bold text-slate-800 placeholder:text-slate-400 placeholder:font-medium pl-12 pr-8 py-2.5 outline-none';
      case 'mobile':
