      ...
      {!isLoginPage && (
        <footer className="relative mt-10 md:mt-24 pt-12 md:pt-24 pb-8 md:pb-12 bg-slate-100/60 border-t border-slate-200 overflow-hidden">
          <div className="relative z-10 w-full px-4 sm:px-6 lg:px-10">
            {/* Footer Brand Header */}
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-8 md:pb-10 mb-8 md:mb-12 border-b border-slate-200/80">
              <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6">
                ...
                <p className="text-xs font-semibold text-slate-500 max-w-sm leading-relaxed">
                  Free Ads, Sell Fast, Buy Local, Canada Wide. Canada's trusted local classifieds marketplace.
                </p>
              </div>
