...
try {
    ...
    if ($m === "hello" || $m === "hi" || $m === "hey") {
        echo json_encode(["text" => "Hi there! I am your MarketHub AI assistant. I can search our live database for items, or guide you on how to use the site. What do you need help with?"]);
        exit();
    }
    ...
    echo json_encode(["text" => "I'm your friendly MarketHub Assistant! Try asking me how to post an ad, how to search, or ask me to check if we have a specific item like 'laptop' or 'car' in our database."]);
